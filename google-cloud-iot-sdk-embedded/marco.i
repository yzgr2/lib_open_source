...
# 58 "marco.c"
typedef iotc_state_t iotc_event_handle_return_t; typedef void* iotc_event_handle_arg1_t; typedef void* iotc_event_handle_arg2_t; typedef iotc_state_t iotc_event_handle_arg3_t; typedef void* iotc_event_handle_arg4_t; typedef void* iotc_event_handle_arg5_t; typedef void* iotc_event_handle_arg6_t; typedef iotc_event_handle_return_t(iotc_event_handle_func_argc0)(void); typedef iotc_event_handle_func_argc0* iotc_event_handle_func_argc0_ptr; typedef iotc_event_handle_return_t(iotc_event_handle_func_argc1)( iotc_event_handle_arg1_t); typedef iotc_event_handle_func_argc1* iotc_event_handle_func_argc1_ptr; typedef iotc_event_handle_return_t(iotc_event_handle_func_argc2)( iotc_event_handle_arg1_t, iotc_event_handle_arg2_t); typedef iotc_event_handle_func_argc2* iotc_event_handle_func_argc2_ptr; typedef iotc_event_handle_return_t(iotc_event_handle_func_argc3)( iotc_event_handle_arg1_t, iotc_event_handle_arg2_t, iotc_event_handle_arg3_t); typedef iotc_event_handle_func_argc3* iotc_event_handle_func_argc3_ptr; typedef iotc_event_handle_return_t(iotc_event_handle_func_argc4)( iotc_event_handle_arg1_t, iotc_event_handle_arg2_t, iotc_event_handle_arg3_t, iotc_event_handle_arg4_t); typedef iotc_event_handle_func_argc4* iotc_event_handle_func_argc4_ptr; typedef iotc_event_handle_return_t(iotc_event_handle_func_argc5)( iotc_event_handle_arg1_t, iotc_event_handle_arg2_t, iotc_event_handle_arg3_t, iotc_event_handle_arg4_t, iotc_event_handle_arg5_t); typedef iotc_event_handle_func_argc5* iotc_event_handle_func_argc5_ptr; typedef iotc_event_handle_return_t(iotc_event_handle_func_argc6)( iotc_event_handle_arg1_t, iotc_event_handle_arg2_t, iotc_event_handle_arg3_t, iotc_event_handle_arg4_t, iotc_event_handle_arg5_t, iotc_event_handle_arg6_t); typedef iotc_event_handle_func_argc6* iotc_event_handle_func_argc6_ptr;
                                                                           ;
...
iotc_event_handle_t iotc_make_empty_handle_impl(const uint8_t target_tid) {
  return (iotc_event_handle_t){ -1, .handlers.h0 = {0}, target_tid };
}
...
int main()
{
  ...
  iotc_event_handle_t handle = iotc_make_handle_argc3(0, func, &a1, &a2, IOTC_STATE_OK);
